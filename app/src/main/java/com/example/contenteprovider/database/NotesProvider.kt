...
class NotesProvider : ContentProvider() {
    ...
    override fun getType(uri: Uri): String? {
        //serve para validar uma URL, dados de imagem,arquivo
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        if (mUriMatcher.match(uri)== NOTES){
            ...
            throw UnsupportedSchemeException("uri invalida para insierção")

    }

    override fun query(// seleciona os arquivos - serve como select
    ...
    companion object {
        ...
        const val AUTHORITY = "com.couses.applicationcontentprovider.provider"
